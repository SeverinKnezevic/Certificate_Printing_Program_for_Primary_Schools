...
Public Class Printanje2
    Private Sub Izlaz_Click(sender As Object, e As EventArgs) Handles Izlaz.Click
        Me.Close()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        wd.Visible = True
        wdDoc = wd.Documents.Add("G:\PROJEKTI 2021\Svjedodžbe Osnovne škole (Visual Basic)\Svjedodžbe Osnovne škole\templates\svjedodzba_zavrsetak_skole.DOC") 'Putanja...'
        ...
        With wdDoc
            ...
            ElseIf spol.Text = "Ž" Then
                ...
                .FormFields("zensko1").Result = "--"
                .FormFields("zensko2").Result = "--"
                .FormFields("zensko3").Result = "--"
            End If
        ...
        '   PUTANJA  (Prepravi je...)'
        wdDoc.SaveAs("G:\PROJEKTI 2021\Svjedodžbe Osnovne škole (Visual Basic)\Svjedodžbe Osnovne škole\Printane_svjedodžbe\" & ime.Text & " " & prezime.Text & " - svjedodžba.DOC") 'Saves the Document
